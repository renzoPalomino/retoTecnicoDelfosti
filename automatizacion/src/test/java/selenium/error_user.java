...
public class error_user {
    public static void main(String[] args) {
        ...
        //Login
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(timeWait));
        ...
        WebElement buttonReturnItem1 = driver.findElement(By.xpath("/html/body/div/div/div/div[1]/div[2]/div/button"));
        buttonReturnItem1.click();
